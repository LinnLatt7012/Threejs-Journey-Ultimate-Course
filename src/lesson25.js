...
import testVertexShader from './shaders/test1/vertex.glsl'
import testFragmentShader from './shaders/test1/fragment.glsl'
// Scene
...
const plane = new THREE.Mesh(gemoetry,material)
